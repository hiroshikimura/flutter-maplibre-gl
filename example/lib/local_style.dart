...
class LocalStyleState extends State<LocalStyle> {
  ...
  initState() {
    ...
    getApplicationDocumentsDirectory().then((dir) async {
      ...
      const styleJSON =
          '{"version":8,"name":"Demo style","center":[50,10],"zoom":4,"sources":{"demotiles":{"type":"vector","url":"https://demotiles.maplibre.org/tiles/tiles.json"} ,"mytiles": {"type": "vector","tiles": ["https://map.dekaihiroshi.net/styles/osm-bright/{z}/{x}/{y}.png"]} },"sprite":"","glyphs":"https://orangemug.github.io/font-glyphs/glyphs/{fontstack}/{range}.pbf","layers":[{"id":"background","type":"background","paint":{"background-color":"rgba(255, 255, 255, 1)"}},{"id":"countries","type":"line","source":"mytiles","source-layer":"countries","paint":{"line-color":"rgba(0, 0, 0, 1)","line-width":1,"line-opacity":1}}]}';
